            ...
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-5">
                ...
                <h1 className="text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
                  Terms & Conditions for SmartCommutePlanner
                </h1>
                <p className="max-w-2xl text-base leading-8 text-slate-700">
                  These terms govern your use of the website, products, and
                  Services offered by SmartCommutePlanner. Please review them
              ...
              <div className="grid w-full gap-4 sm:w-auto sm:grid-cols-2">
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                  ...
                  <p className="mt-2 leading-6 text-slate-600">
                    Accept and follow these terms whenever you use our website
                    and Services.
                  </p>
                </div>
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                  ...
                  <p className="mt-2 leading-6 text-slate-600">
                    Do not violate laws, spread malware, or misuse the Service.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  These Terms apply across all users, buyers, and contributors
                  on the site.
                </p>
              </div>
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  We may change the site or the Terms at any time, and continued
              ...
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  Sectioned content helps make the terms easier to scan and
                  understand.
                </p>
              </div>
            </div>
          ...
          <article className="rounded-4xl border border-slate-200 bg-white p-10 shadow-sm">
            ...
            <div className="mt-10 space-y-10 text-slate-700">
              <section className="space-y-4">
                ...
                <p>
                  This website is operated by Smart Commute Planner. Throughout
                  the site, the terms “we”, “us” and “our” refer to Smart
                  Commute Planner. Smart Commute Planner offers this website,
              ...
              <section className="space-y-4">
                ...
                <p>
                  ...
                  only according to our Return Policy. To view our Return
                  Policy, please visit [LINK TO RETURN POLICY]
                </p>
                <p>
              ...
              <section className="space-y-4">
                ...
                <p>
                  In no case shall Smart Commute Planner, our directors,
              ...
              <section className="space-y-4">
                ...
                <p>
                  You agree to indemnify, defend and hold harmless Smart Commute
                  Planner and our parent, subsidiaries, affiliates, partners,
