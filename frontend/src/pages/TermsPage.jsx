            ...
            <div className="grid w-full gap-4 sm:w-auto sm:grid-cols-2">
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                ...
                <p className="mt-2 leading-6 text-slate-600">
                  Accept and follow these terms whenever you use our website and
                  Services.
                </p>
              </div>
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
              ...
              <p className="text-sm leading-6 text-slate-300">
                These Terms apply across all users, buyers, and contributors on
                the site.
              </p>
            </div>
            <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
          ...
          <div className="mt-10 space-y-10 text-slate-700">
            <section className="space-y-4">
              ...
              <p>
                ...
                the site, the terms “we”, “us” and “our” refer to Smart Commute
                Planner. Smart Commute Planner offers this website, including
            ...
            <section className="space-y-4">
              ...
              <p>
                In no case shall Smart Commute Planner, our directors, officers,
