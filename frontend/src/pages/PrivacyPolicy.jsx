import { FiShield, FiLock, FiGlobe, FiClock } from "react-icons/fi";
    ...
    <>
      <main className="min-h-screen bg-slate-100 text-slate-950">
        <section className="mx-auto max-w-7xl space-y-10 px-4 py-16 sm:px-6 lg:px-8">
          <div className="rounded-4xl border border-slate-200 bg-white p-10 shadow-sm shadow-slate-200">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-5">
                ...
                <h1 className="text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl">
                  Our commitment to privacy, clarity, and secure route planning.
                </h1>
                <p className="max-w-2xl text-base leading-8 text-slate-700">
                  Learn how SmartCommutePlanner collects, stores, and protects
                  your personal information while building better commute
                  decisions.
                </p>
              ...
              <div className="grid w-full gap-4 sm:w-auto sm:grid-cols-2">
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                  <div className="inline-flex items-center gap-2 font-semibold text-slate-950">
                    <FiLock
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Security-first handling of information and access controls.
                  </p>
                </div>
                <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
                  <div className="inline-flex items-center gap-2 font-semibold text-slate-950">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    We only share data when needed for service delivery and
                    transparency.
                  </p>
                </div>
              </div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                <div className="mb-3 inline-flex items-center gap-2 text-sm uppercase tracking-[0.2em] text-sky-300">
                  <FiClock className="h-4 w-4" aria-hidden="true" />
                  Keep You Informed
                </div>
                <p className="text-sm leading-6 text-slate-300">
                  Updated policy details and transparency around data use.
                </p>
              </div>
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                <div className="mb-3 inline-flex items-center gap-2 text-sm uppercase tracking-[0.2em] text-sky-300">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  Respectful collection and secure retention of your
              ...
              <div className="rounded-3xl bg-slate-950 px-5 py-6 text-white shadow-sm">
                ...
                <p className="text-sm leading-6 text-slate-300">
                  Data usage designed to improve route safety and planning
                  accuracy.
                </p>
              </div>
            </div>
          ...
          <article className="rounded-4xl border border-slate-200 bg-white p-10 shadow-sm">
            <div className="flex flex-col gap-6 border-b border-slate-200 pb-6 sm:flex-row sm:items-center sm:justify-between">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-semibold text-slate-950">
                  Our policy, organized for easy reading
                </h2>
              </div>
              <Link
                to="/about"
                className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-900 transition hover:bg-slate-200"
              >
            ...
            <div className="mt-10 space-y-8 text-slate-700">
              <div>
                ...
                <p className="mt-4 leading-8">
                  ...
                  you use the Service. It explains your privacy rights and how
                  the law protects you.
                </p>
                <p className="mt-4 leading-8">
                  We use personal data to provide and improve the Service. By
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Privacy Policy) refers to Smart
                    Commute Planner.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Smart Commute Planner,
                    accessible from{" "}
                    <a
                      href="https://www.smartcommplanner.com/"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://www.smartcommplanner.com/
                    </a>
                    .
                  </p>
                </li>
              ...
              <p>
                ...
                using Our cookie preferences tool (if available) or through Your
              ...
              <ul>
                <li>
                  <p>By email: smartcommuteplanner@gmail.com</p>
                </li>
                <li>
                  <p>
